...
| **完整版** | **Beta** | 0.0.6 | [下载](https://github.com/qpingcode/MyGestures/releases/download/v0.0.6/MyGestures-0.0.6-windows-x64-full-setup.exe) | [下载](https://github.com/qpingcode/MyGestures/releases/download/v0.0.6/MyGestures-0.0.6-windows-x64-full-portable.zip) |
| **精简版** | **Beta** | 0.0.6 | [下载](https://github.com/qpingcode/MyGestures/releases/download/v0.0.6/MyGestures-0.0.6-windows-x64-lite-setup.exe) | [下载](https://github.com/qpingcode/MyGestures/releases/download/v0.0.6/MyGestures-0.0.6-windows-x64-lite-portable.zip) |
